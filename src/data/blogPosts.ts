...
export const blogPosts: BlogPost[] = [
  {
    ...
    excerpt:
      "A coastal kitchen shaped by family, memory, and the quiet rituals of feeding people well.",
    content: [
  ...
  },
  {
    ...
    excerpt:
      "On the emotional geography of meals, memory, and the recipes we return to.",
    content: [
  ...
  },
  {
    ...
    excerpt:
      "Coffee, sea wind, citrus on the counter, and breakfast without rushing.",
    content: [
  ...
  },
  {
    ...
    excerpt:
      "The olive oil, grains, herbs, citrus, and sea salt that hold a week of good meals together.",
    content: [
  ...
  },
  {
    ...
    excerpt:
      "A gentler way to gather, with food that lets you stay present at your own table.",
    content: [
  ...
  },
  {
    ...
    excerpt:
      "A practical note on making nourishing meals from a few honest ingredients.",
    content: [
