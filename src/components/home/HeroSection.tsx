...
export function HeroSection() {
  return (
    <section className="relative min-h-[78vh] overflow-hidden bg-charcoal text-warm">
      <Image alt="" className="image-treatment object-cover opacity-72" fill priority src="/images/brand/coastal-table.svg" />
      ...
      <div className="container relative flex min-h-[78vh] items-center py-20">
        <div className="max-w-3xl">
          <p className="text-xs uppercase tracking-[0.2em] text-warm/72">Rooted in nourishment, seasoned by the sea.</p>
          ...
          <p className="mt-4 text-warm/70">Recipes, videos, meal inspiration, and kitchen stories from a coastal home.</p>
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            <Button href="/membership">Join the membership</Button>
            <Button className="border-warm/50 text-warm hover:border-warm hover:text-warm" href="/recipes" variant="secondary">
              Explore recipes
            </Button>
          </div>
        </div>
